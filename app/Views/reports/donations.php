<?php 
$page_title = 'Donations Report - ' . SITE_NAME;
$auth = new Auth();
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Donations Report</h1>
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="http://localhost/church-system/public/reports/donations?start_date=<?= e($start_date) ?>&end_date=<?= e($end_date) ?>&pdf=1" target="_blank" class="btn btn-sm btn-danger me-2">
...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="http://localhost/church-system/public/reports/donations" class="row g-3">
            <div class="col-md-4">
...
<div class="row mb-4">
    <div class="col-md-12">
        <div class="card bg-success text-white">
            <div class="card-body">
                <h5 class="card-title">Total Donations (<?= e($start_date) ?> to <?= e($end_date) ?>)</h5>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $currency . number_format($donor->total, 2) ?></td>
                            <td><?= number_format($donor->count) ?></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
